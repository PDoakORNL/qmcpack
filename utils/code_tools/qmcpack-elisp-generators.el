...
;; ((string-equal my-type "std::string") (setq my-type (concat "const " my-type "&")))
;; 		  ((string-match "std::vector" my-type) (setq my-type (concat "const " my-type "&")))
	    (cond ((string-equal my-type "int"))
		  ((string-equal my-type "bool"))
		  ((string-equal my-type "float"))
		  ((string-equal my-type "double"))
		  (t (setq my-type (concat "const " my-type "&"))))
