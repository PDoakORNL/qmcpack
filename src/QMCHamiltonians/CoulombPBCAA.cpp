                               ...
                               const std::vector<ListenerVector<RealType>>& listeners) const
{
  ...
  auto evaluate_walker = [num_species, num_centers, name, &v_sample](const int walker_index, const CoulombPBCAA& cpbcaa, const ParticleSet& pset,
