...
MockGoldWalkerElements::MockGoldWalkerElements(Communicate* comm, RuntimeOptions& runtime_opt, WaveFunctionPoolFactoryFunc wavefunction_pool_fac_func, HamPoolFactoryFunc ham_pool_fac_func)
...
MockGoldWalkerElements makeGoldWalkerElementsWithEE(Communicate* comm, RuntimeOptions runtime_opt) {
  ...
  MockGoldWalkerElements::WaveFunctionPoolFactoryFunc wfp_diamondC = std::bind(&MinimalWaveFunctionPool::make_diamondC_1x1x1, _1, _2, _3);
