 ...
 */
  ...
  void EstimatorManagerNew::collectScalarEstimators(
      const std::vector<RefVector<ScalarEstimatorBase>>& crowd_scalar_ests)
  {
  ...
  bool EstimatorManagerNew::put(QMCHamiltonian & H, const ParticleSet& pset, const TrialWaveFunction& twf,
                                xmlNodePtr cur)
  {
